<template>
    <div v-if="model">
        <Modal width="50" v-model="model" :transfer="true" :mask-closable="false" @on-visible-change="change" :styles="{top:0}">
            <div slot="header">{{ modify?  '修改UPSTREAM GROUP' : '新建UPSTREAM GROUP' }}</div>
            <div class="virtual_server_form modal-body" :class="{'modal-body-show':isTaskbarShow}">
                ...
                <upstream-group-name :modify="modify" :data="groupName" @edit="checkEditStatus" @readyOk='prepareConfig'>
                </upstream-group-name>
                <upstream-servers :modify="modify" :data="servers" @edit="checkEditStatus" @readyOk='prepareConfig'>

                </upstream-servers>
                <load-balancing-method :modify="modify" :data="loadBalancing" @edit="checkEditStatus" @readyOk='prepareConfig'></load-balancing-method>
                <session-persistence :modify="modify" :data="session" @edit="checkEditStatus" @readyOk='prepareConfig'></session-persistence>
                <upstream-zone :modify="modify" :data="uptZone" @edit="checkEditStatus" @readyOk='prepareConfig'></upstream-zone>
                <active-health-check :modify="modify" :data="activeHealthcheck" @edit="checkEditStatus" @readyOk='prepareConfig'></active-health-check>
                <keep-alive-connection-pool :modify="modify" :data="keepalive" @edit="checkEditStatus" @readyOk='prepareConfig'></keep-alive-connection-pool>
                <Queueing :modify="modify" :data="queueing" @edit="checkEditStatus" @readyOk='prepareConfig'></Queueing>
                <ntln-authentication :modify="modify" :data="ntlmAuthentication" @edit="checkEditStatus" @readyOk='prepareConfig'></ntln-authentication>
                <persistent-state :modify="modify" :data="persistentState" @edit="checkEditStatus" @readyOk='prepareConfig'></persistent-state>
    ...
    watch: {
        ...
        data: {
            handler(nv, ov) {
                ...
                this.loadBalancing = {
                    load_balancing_method: this.serverForm
                        .load_balancing_method,
                    hash_key: this.serverForm.hash_key,
                    ketama_consisten_state: this.serverForm
                        .ketama_consisten_state,
                    time_to_receive: this.serverForm.time_to_receive,
                    serve_incomplete_requests_state: this.serverForm
                        .serve_incomplete_requests_state,
                };
                this.session = {
                    session_persistence_state: this.serverForm
                    ...
                    cookie_httponly_state: this.serverForm
                        .cookie_httponly_state,
                    ...
                    leam_shared_memory_zone: this.serverForm
                        .leam_shared_memory_zone,
                    leam_session_remove_timeout: this.serverForm
                ...
                this.activeHealthcheck = {
                    active_healthcheck_state: this.serverForm
                        .active_healthcheck_state,
                    healthcheck_url: this.serverForm.healthcheck_url,
                    healthcheck_host: this.serverForm.healthcheck_host,
                };
                this.keepalive = {
                    keepalive_connection_pool_state: this.serverForm
                        .keepalive_connection_pool_state,
                    keepalive_connection_pool_value: this.serverForm
                ...
                this.ntlmAuthentication = {
                    ntlm_authentication_state: this.serverForm
                        .ntlm_authentication_state,
                };
