        ...
        <div class="content_header">
            ...
            <span>
              ...
              >
                <div class="content">
                  ...
                  <div class="row-item">
                    <div class="status">
                      <span>keepalived版本号</span>:
                      {{
                        appInfo.ha_version === "null"
                          ? "无"
                          : appInfo.ha_version
                      }}
                    </div>
          ...
          <div class="header_tab">
            <div class="tab">
              ...
              <router-link
                :to="`/L7/${$route.params.L7}/nginx`"
                class="tab_item"
                >{{ activeAside.nginxVersion || "NGINX version" }}</router-link
              >
              <router-link
                :to="`/L7/${$route.params.L7}/chart`"
                class="tab_item"
                >系统</router-link
              >

              <router-link
                :to="`/L7/${$route.params.L7}/config`"
                class="tab_item"
                >配置</router-link
              >
            ...
            <apply-filter
              v-if="$route.name === 'L7Chart' || $route.name === 'L7Nginx'"
            />
          </div>
        </div>
        <div class="contents">
          <div
            class="cover"
            v-if="!activeAside.usable_status"
            :class="
              $route.name === 'L7Chart'
                ? 'coverheight'
                : '' || $route.name === 'L7Nginx'
          ...
          <div
            class="word"
            v-if="!activeAside.usable_status"
            :class="$route.name === 'L7Config' ? 'word-display' : ''"
          >
            <div class="word-icon">
              <Icon type="md-warning" size="50" style="color: #fbff05;" />
            </div>
