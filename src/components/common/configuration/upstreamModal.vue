    ...
    >
        <div class="virtual_server_form" >
            ...
            <Form ref="serverForm" :model="serverForm" :rules="serverFormRules"   @submit.native.prevent>
                <my-form-item title="UPSTREAM GROUP NAME"
                ...
                <my-form-item :obj="serverForm.listening_m.listening" title="UPSTREAM SERVERS"
                                    ...
                                    <div class="ctrl-edit-item ctrl-edit-item_edit mulity upstream ">
                                        ...
                                        <div class="item-body">
                                            ...
                                            <FormItem label="RESOLVE" class="aline-center">
                                                ...
                                                <PopTip style="margin-left: 10px;margin-top: 2px;" :size="18" content="To make this work you should setup the shared memory zone inside the upstream group.Also, the resolver directive must be specified in the http block." placement="right"></PopTip>
                                            </FormItem>
                                            <FormItem label="ROUTE NAME" class="inline-form-item">

                                                <Input placeholder="name"></Input>
                                            </FormItem>
                                            <FormItem label="WEIGHT RECOVERING TIME
" class="inline-form-item">
                ...
                <my-form-item title="LOAD BALANCING METHOD"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                    ...
                    <div slot="edit" class="ctrl-edit-item ctrl-edit-item_edit">
                        ...
                        <div class="ctrl-edit-item__note">Requests are distributed between the servers using a weighted round-robin balancing method</div>
                ...
                <my-form-item title="SESSION PERSISTENCE"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                ...
                <my-form-item title="UPSTREAM ZONE"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                ...
                <my-form-item title="ACTIVE HEALTHCHECK"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                ...
                <my-form-item title="KEEPALIVE CONNECTION POOL"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                ...
                <my-form-item title="NTLM AUTHENTICATION"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
                ...
                <my-form-item title="PERSISTENT STATE"
                              @closeConfig = "closeConfig('domain')"
                              @saveConfig = "saveConfig('domain')"
