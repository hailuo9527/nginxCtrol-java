<template>
  <div class="overview-box">
    <div >
      <h3 class="overview-box__title">APP
        <!--<Icon class="remove-icon" @click="remove" type="md-close" size="20" color="#333"/>-->
      </h3>
      ...
      <div class="overview-box__r">
        ...
        <span class="overview-box__r__val">{{ numerify(data.requestCountPast,'0 a') }}</span>
      </div>
      <div class="x-chart">
        <ve-line
