            ...
            >
              <Col span="10">
                <FormItem
                  label=""
                  :prop="
                    'appDefaultPublishConfList.' + index + '.upstream_server'
                  "
                  :rules="{ validator: ipPort }"
                >
                  <Input
                    type="text"
                    v-model="item.upstream_server"
              ...
              <Col span="8" :offset="1">
                <FormItem
                  ...
                  :prop="'appDefaultPublishConfList.' + index + '.weight'"
                >
                  <Input
                    type="text"
                    v-model="item.weight"
